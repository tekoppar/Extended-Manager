...
#pragma pack(push, 1)
namespace Moon {
	class MoonMessageBox : public Moon::MonoBehaviour
	{
	...
	public:
		...
		Moon::MessageProvider* MessageProvider; // 0x48
		...
		Moon::GameObject Button; // 0x68
		Moon::GameObject Separator; // 0x70
		bool ShouldWriteOut; // 0x78

		Moon::HString* get_CurrentMessage()
		{
			auto get_CurrentMessage_address = Assembly_BaseAddr + 0x486280;
			using __get_CurrentMessage = Moon::HString * (*)(Moon::MoonMessageBox*);
