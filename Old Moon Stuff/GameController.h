...
#pragma pack(push, 1)
	...
	public:
		...
		static Moon::GameParameters Parameters_k__BackingField; // 0x40
		...
		Moon::HString* BuildID[0x1]; // 0x98
		Moon::HString* BuildIDString[0x1]; // 0xA0
		Moon::HString* BuildName[0x1]; // 0xA8
		...
		{
			((void(__fastcall*)(Moon::GameController*))((Assembly_BaseAddr)+0x997230))(this);
		}

		inline void SuspendGameplay()
		{
			((void(__fastcall*)(Moon::GameController*))((Assembly_BaseAddr)+0x997010))(this);
		}

		inline void ResumeGameplay()
		{
			((void(__fastcall*)(Moon::GameController*))((Assembly_BaseAddr)+0x9970C0))(this);
		}

		inline void PerformSaveGameSequence()
		{
			((void(__fastcall*)(Moon::GameController*))((Assembly_BaseAddr)+0x98CC40))(this);
		}

		Moon::GameParameters get_Parameters()
		{
			auto GetParameters_address = Assembly_BaseAddr + 0x98C450;
			using GameController__get_ShowDebug = GameParameters(*)(Moon::GameController*);
		...
		unsigned int get_TotalExceptionsCount()
		{
			...
			using GameController__get_ShowDebug = int(*)(Moon::GameController*);
		...
		bool get_ShowDebug()
		{
			...
			using GameController__get_ShowDebug = bool(*)(Moon::GameController*);
