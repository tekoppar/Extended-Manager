...
void RaceManager::CreateRecorder()
{
...
bool RaceManager::StartRecorder()
{
	if (ghostC != nullptr)
	{
...
bool RaceManager::WriteRecorder()
{
	if (ghostC != nullptr) {
...
bool RaceManager::CreateGhost(std::string path)
{
	std::string ghostPath = getexepath();
...
void RaceManager::CheckIfGhostsFinished()
{
