...
namespace tem {
	...
	public:
		...
		void CreateObject(std::string Namespace, std::string Class)
		{
			...
			TransformSetPosition(gameObject, tem::Vector3(-1319.66f, -4543.13f, 0.0f).ToMoon());

			switch (sutil::hash(Class.c_str()))
			{
				case sutil::hash("SceneManagerScene"):
				{
					tem::Rect rect = tem::Rect(-1389.36f, -4399.85f, 345.89f, 138.96f);
					tem::Rect loadingRect = tem::Rect(-1055.40f, -4391.93f, 83.49f, 154.08f);
					tem::Vector3 position = tem::Vector3(-1319.66f, -4543.13f, 0.0f);
					rect.Y -= rect.Height;
					...
					app::Object_1_set_name((app::Object_1*)gameObject1, string_new("Cuuube"), NULL);
					...
					temScene1RuntimeMetaData->fields.Scene = string_new("NewGameObject3");
					...
					temScene1MetaData->fields.RootPosition = position.ToMoon();
					...
					app::TimeSlicedActivationTask__ctor(sceneActivation, gameObjectsToEnable, preEnableObservers, postEnableObservers, false, true, gameObject, NULL, string_new("NewGameObject3"), NULL);
					...
					temUnityScene1 = app::SceneManager_CreateScene_1(string_new("NewGameObject3"), NULL);
					...
					int hashcode = app::String_GetHashCode(string_new("NewGameObject3"), NULL);
